...
if ( class_exists( 'BWS_BKNG_Pre_Order_Widget' ) )
	return;

class BWS_BKNG_Pre_Order_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			$prefix . __( 'Order Details', BWS_BKNG_TEXT_DOMAIN ),
			array( 'description' => '' )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( $bws_bkng->is_booking_post() )
			...
			if ( 'checkout' == $page || ( 'thank_you' == $page && bkng_get_order_id() ) )
